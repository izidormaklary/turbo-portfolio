...
export default function Hero() {
  return (
    <div className="h-screen w-full  flex flex-col items-center justify-end  bg-gradient-to-b shadow-foreground  from-foreground/20 dark:from-foreground/10 to-background">
      <div className="flex container grow p-2 sm:p-0 justify-self-center justify-center">
        <div className=" hidden sm:block self-center max-max-w-max p-6 md:p-24">
          <Image
            ...
            className="rounded-full aspect-square shadow-md h-full w-full"
            width={220}
            height={220}
